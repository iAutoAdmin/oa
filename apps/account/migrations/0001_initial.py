# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-09-26 04:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'auth_user',
                'ordering': ['id'],
                'permissions': (('view_user', 'cat view user'),),
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_dept', models.ForeignKey(help_text='上级部门', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parent_department', to='account.Department', verbose_name='上级部门')),
            ],
            options={
                'verbose_name': '用户部门表',
                'db_table': 'auth_user_department',
                'ordering': ['id'],
                'permissions': (('view_department', 'cat view department'),),
            },
        ),
        migrations.AddField(
            model_name='user',
            name='department',
            field=models.ForeignKey(help_text='部门', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='department', to='account.Department', verbose_name='部门'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
