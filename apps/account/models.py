...
class User(AbstractUser):
    ...
    department       = models.ForeignKey('Department', null=True, verbose_name='部门', help_text='部门')
...
class Department(models.Model):
    ...
    parent_dept      = models.ForeignKey('self', related_name='children', null=True, verbose_name="子部门", help_text="子部门门")
    # leader           = models.IntegerField(db_index=True, null=True, verbose_name="部门领导", help_text="领导")
    leader           = models.ForeignKey('User', related_name='department_leader', null=True, verbose_name="部门领导", help_text="领导")
